            ...
            {animationStage === 'typing' && (
              <div className="demo-address">
                <div className="flex items-center gap-3 bg-background/40 backdrop-blur-2xl rounded-2xl p-4 shadow-lg border border-border/30 relative overflow-hidden group">
                  ...
                  <span className="font-medium text-foreground/80 typing-text">
            ...
            {animationStage === 'results' && (
              <div className="demo-house animate-fade-in">
                ...
                <div className="absolute inset-0 z-20">
                  ...
                  <div className="absolute top-1/4 left-1/4 group animate-marker-reveal delay-[1000ms]">
                    <div className="relative">
                  ...
                  <div className="absolute bottom-1/3 right-1/4 group animate-marker-reveal delay-[1200ms]">
                    <div className="relative">
                  ...
                  <div className="absolute top-1/3 right-1/3 group animate-marker-reveal delay-[1400ms]">
                    <div className="relative">
