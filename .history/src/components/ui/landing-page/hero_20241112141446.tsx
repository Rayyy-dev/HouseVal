  ...
  return (
    <section className="container mx-auto px-4 pt-32 pb-24">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
        ...
        <div className="relative h-[650px] group perspective-1000">
          <div className="absolute inset-0 bg-gradient-to-br from-primary/10 via-transparent to-primary/10 rounded-3xl opacity-0 group-hover:opacity-100 transition-opacity duration-700" />
          
          <div className="relative w-full h-full rounded-3xl overflow-hidden transform-gpu transition-transform duration-700 preserve-3d hover:rotate-y-3 hover:scale-[1.02]">
            <div 
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-background/95 via-background/20 to-transparent">
              <div className="absolute bottom-0 left-0 right-0 p-8">
                <div 
                  className={`bg-background/40 backdrop-blur-2xl rounded-2xl p-6 shadow-2xl 
                    transform transition-all duration-700 hover:bg-background/60
                ...
                >
                  <div className="flex items-center justify-between mb-6">
                    ...
                    <span className="px-3 py-1 rounded-full text-sm bg-primary/10 text-primary backdrop-blur-sm">
                      {scenarios[currentScenario].beds}
                    </span>
                  </div>

                  <div className="space-y-5">
                    <div className="flex items-center justify-between px-3 py-2 rounded-xl bg-background/40 backdrop-blur-sm">
                      <span className="text-sm text-muted-foreground">Size</span>
                      <span className="font-medium">{scenarios[currentScenario].size}</span>
                    </div>
                    
                    <div className="px-3 py-4 rounded-xl bg-background/40 backdrop-blur-sm">
