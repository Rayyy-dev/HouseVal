                ...
                <div className="w-full max-w-2xl space-y-6">
                  ...
                  <div className="flex items-center gap-3 bg-background/40 backdrop-blur-2xl rounded-2xl p-4 shadow-lg border border-border/30 relative overflow-hidden group">
                    ...
                    <div className="flex-1 space-y-1">
                      <div className="text-sm text-muted-foreground">Enter Property Address</div>
                      <div className="font-medium text-foreground/90 typing-text">
                  ...
                  {/* AI Assistant Hint */}
                  <div className="flex items-center gap-3 bg-background/40 backdrop-blur-xl rounded-xl p-3 border border-border/20 animate-fade-in-delay-1">
