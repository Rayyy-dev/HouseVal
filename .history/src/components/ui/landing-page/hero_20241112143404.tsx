        ...
        <div className="space-y-8">
          <div className="space-y-4">
            <h1 className="text-6xl sm:text-7xl font-bold leading-[1.1] tracking-tight">
              ...
              <br />
              <span className="text-5xl sm:text-6xl bg-gradient-to-br from-foreground to-foreground/80 bg-clip-text text-transparent mt-4 block">
                with AI Precision
              </span>
            </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4 max-w-xl">
            <div className="relative flex-1">
              ...
              <Input 
                ...
                className="pl-12 h-14 text-base rounded-xl border-border/50 bg-background/50 backdrop-blur-sm hover:bg-background/70 transition-colors shadow-sm"
              />
              {isAnalyzing && (
              ...
              <div className="text-center">
                <div className="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-primary/5 backdrop-blur-sm mb-4">
                  ...
                  <span className="text-sm text-muted-foreground animate-typing">
                    {isAnalyzing ? address : 'Enter a property address'}
                  </span>
                </div>
                {isAnalyzing && (
