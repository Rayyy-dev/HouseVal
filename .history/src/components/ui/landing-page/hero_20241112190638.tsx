                ...
                <div className="w-full max-w-2xl space-y-4">
                    ...
                    <div className="flex items-start gap-3 animate-fade-up">
                      ...
                      <div className="flex-1">
                        <div className="bg-muted/50 backdrop-blur-sm rounded-2xl rounded-tl-none p-4 text-sm text-foreground/80 shadow-sm border border-border/50">
                          <span className="typing-animation-1">Hello! Please enter a property address for AI analysis.</span>
                        </div>
                      </div>
                    </div>
                  )}
                  ...
                  {chatStep >= 2 && (
                    <div className="flex items-start gap-3 animate-fade-up">
                      ...
                      <div className="flex-1">
                        <div className="bg-muted/50 backdrop-blur-sm rounded-2xl rounded-tl-none p-4 text-sm text-foreground/80 shadow-sm border border-border/50">
                          <span className="typing-animation-2">For example: 1234 Innovation Drive, Silicon Valley, CA</span>
                        </div>
                      </div>
                    </div>
                  )}
                    ...
                    <div className="flex items-start gap-3 justify-end animate-fade-up">
                      <div className="flex-1 max-w-[80%]">
                        <div className="bg-primary/10 backdrop-blur-sm rounded-2xl rounded-tr-none p-4 text-sm shadow-sm border border-primary/20 ml-auto">
                          <span className="typing-animation-3">1234 Innovation Drive, Silicon Valley, CA</span>
                        </div>
                      </div>
                  ...
                  {chatStep >= 4 && (
                    <div className="flex items-start gap-3 animate-fade-up">
                      ...
                      <div className="flex-1">
                        <div className="bg-muted/50 backdrop-blur-sm rounded-2xl rounded-tl-none p-4 text-sm text-foreground/80 shadow-sm border border-border/50">
                          <span className="typing-animation-4">Analyzing property details...</span>
                        </div>
                      </div>
                    </div>
                  )}
