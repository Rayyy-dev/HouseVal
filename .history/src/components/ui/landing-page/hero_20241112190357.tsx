...
export function Hero() {
  ...
  useEffect(() => {
    const sequence = async () => {
      ...
      // Wait for ALL typing animations to complete (increased from 3000)
      await new Promise(resolve => setTimeout(resolve, 8000));
      
      // Start analysis
      setAnimationStage('analyzing');
      
      // Wait for analysis animation (increased from 2500)
      await new Promise(resolve => setTimeout(resolve, 4000));
      
      // Show results
      setAnimationStage('results');
      
      // Reset after showing results (increased from 5000)
      await new Promise(resolve => setTimeout(resolve, 8000));
  ...
  useEffect(() => {
    if (animationStage === 'typing') {
      const chatSequence = async () => {
        ...
        // First message with AI assistant
        await new Promise(resolve => setTimeout(resolve, 1000));
        setChatStep(1); // "Hello! I'm your AI assistant..."
        
        // Example prompt appears
        await new Promise(resolve => setTimeout(resolve, 2500));
        setChatStep(2); // "Enter an address like: 123 Main St..."
        
        // User input simulation
        await new Promise(resolve => setTimeout(resolve, 2500));
        setChatStep(3); // Simulated user typing
        
        // Processing confirmation
        await new Promise(resolve => setTimeout(resolve, 2000));
        setChatStep(4); // "Analyzing property data..."
      };
      chatSequence();
    }
  }, [animationStage]);
          ...
          <div className="demo-container">
            ...
            {animationStage === 'typing' && (
              <div className="demo-address absolute inset-0 flex items-center justify-center p-6">
                <div className="relative w-full max-w-2xl mx-auto bg-background/80 backdrop-blur-sm rounded-xl border border-border/50 shadow-2xl">
                  <div className="p-6 space-y-4">
                    ...
                    {chatStep >= 1 && (
                      <div className="flex items-start gap-3 animate-fade-in">
                        ...
                        <div className="flex-1">
                          <div className="typing-effect bg-muted/50 rounded-2xl rounded-tl-none p-4">
                            <p className="text-sm text-foreground/80">
                              Hello! I'm your AI assistant. Let me help you analyze a property.
                            </p>
                          </div>
                        </div>
                      </div>
                    ...
                    {/* AI Example Message */}
                    {chatStep >= 2 && (
                      <div className="flex items-start gap-3 animate-fade-in-delay">
                        <div className="flex-shrink-0 h-8 w-8 rounded-full bg-primary/10 border border-primary/20 flex items-center justify-center">
                        ...
                        <div className="flex-1">
                          <div className="typing-effect bg-muted/50 rounded-2xl rounded-tl-none p-4">
                            <p className="text-sm text-foreground/80">
                              Enter an address like: 123 Main Street, San Francisco, CA
                            </p>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="flex items-start gap-3 justify-end">
                        <div className="flex-1 max-w-[80%]">
                          <div className="bg-primary/10 rounded-2xl rounded-tr-none p-4">
                            <p className="text-sm text-foreground/90 typing-cursor">
                              742 Evergreen Terrace, Springfield
                            </p>
                          </div>
                        </div>
                        <div className="flex-shrink-0 h-8 w-8 rounded-full bg-background border border-border/50 flex items-center justify-center">
