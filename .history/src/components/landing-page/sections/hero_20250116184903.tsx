              ...
              {animationStage === 'results' && (
                <div className="demo-house animate-fade-in">
                  ...
                  <div className="absolute inset-0 z-20">
                    {/* Price Marker */}
                    <div className="absolute top-1/4 left-1/4 animate-marker-reveal" style={{ animationDelay: '1s' }}>
                      <div className="relative">
                        ...
                        <div className="absolute left-6 top-1/2 -translate-y-1/2">
                          <div className="animate-card-reveal" style={{ animationDelay: '1.2s' }}>
                            <div className="bg-background/80 backdrop-blur-xl rounded-xl p-3 shadow-2xl border border-border/50">
                    ...
                    {/* Size Marker */}
                    <div className="absolute bottom-1/3 right-1/4 animate-marker-reveal" style={{ animationDelay: '1.3s' }}>
                      <div className="relative">
                        <div className="absolute -inset-2 bg-primary/20 rounded-full blur-xl animate-pulse" />
                        <div className="h-4 w-4 rounded-full bg-background/80 backdrop-blur-sm border-2 border-primary flex items-center justify-center">
                          <div className="h-1.5 w-1.5 rounded-full bg-primary" />
                        ...
                        <div className="absolute right-6 top-1/2 -translate-y-1/2">
                          <div className="animate-card-reveal" style={{ animationDelay: '1.5s' }}>
                            <div className="bg-background/80 backdrop-blur-xl rounded-xl p-3 shadow-2xl border border-border/50">
                              <div className="flex items-center gap-2 mb-1">
                    ...
                    {/* Confidence Marker */}
                    <div className="absolute top-1/3 right-1/3 animate-marker-reveal" style={{ animationDelay: '1.6s' }}>
                      <div className="relative">
                        ...
                        <div className="absolute left-6 top-1/2 -translate-y-1/2">
                          <div className="animate-card-reveal" style={{ animationDelay: '1.8s' }}>
                            <div className="bg-background/80 backdrop-blur-xl rounded-xl p-3 shadow-2xl border border-border/50">
                              <div className="flex items-center gap-2 mb-1">
