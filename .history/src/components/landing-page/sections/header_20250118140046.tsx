          ...
          >
            ...
            <div className="relative">
              ...
              >
                ...
                <span className="text-3xl font-black tracking-tighter text-destructive drop-shadow-[0_0_10px_rgba(var(--destructive),0.5)]">
                  val
                </span>
              </motion.div>
              ...
              >
                <motion.div 
                  className="absolute inset-0 bg-gradient-to-r from-primary via-primary to-destructive"
                  animate={{
                    x: ["0%", "100%", "0%"],
                    opacity: [1, 0.5, 1]
                  }}
                ...
                />
                <div className="absolute inset-0 bg-gradient-to-r from-primary/50 via-primary/30 to-destructive/50 shadow-[0_0_15px_rgba(var(--primary),0.3)]" />
              </motion.div>
            </div>
          </motion.div>
        </div>
