              ...
              {animationStage === 'scanning' && (
                ...
                >
                  <div className="relative w-full h-full">
                    {/* House Image */}
                    <div className="absolute inset-0 bg-house-image bg-cover bg-center rounded-xl" />
                    ...
                    <motion.div
                      ...
                      className="absolute left-0 right-0 h-1 bg-gradient-to-b from-primary/60 to-transparent blur-sm"
                    />
                    <motion.div
                      initial={{ top: "0%" }}
                      animate={{ top: "100%" }}
