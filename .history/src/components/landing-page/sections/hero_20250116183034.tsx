...
const TypewriterText = ({ onComplete }: TypewriterTextProps) => {
            ...
            <AnimatePresence mode="wait">
              {animationStage === 'typing' && (
                <motion.div
                  ...
                  animate={{ opacity: 1 }}
                  exit={{ opacity: 0 }}
                  className="absolute top-6 left-6 right-6 p-4 bg-black/90 rounded-lg border border-border/10"
                >
                  ...
                  <div className="flex items-start gap-2">
                    ...
                    <TypewriterText 
                      onComplete={() => setAnimationStage('analyzing')} 
                    />
                  </div>
                </motion.div>
              )}
