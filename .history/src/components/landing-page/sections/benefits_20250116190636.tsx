  ...
  return (
    <section className="relative py-24 overflow-hidden">
      ...
      <div className="absolute inset-0 bg-[#0A0F1E]">
        ...
        >
          <div className="absolute left-0 right-0 top-0 -z-10 m-auto h-[310px] w-[310px] rounded-full bg-primary/10 blur-[120px] animate-pulse-slow" />
          <div className="absolute left-1/3 right-0 top-1/2 -z-10 h-[250px] w-[250px] rounded-full bg-primary/15 blur-[120px] animate-pulse-slow delay-300" />
        </motion.div>
      </div>
      ...
      <div className="container relative z-10 mx-auto px-4">
        ...
        >
          ...
          <p className="text-lg text-slate-400/90 max-w-2xl mx-auto leading-relaxed">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {benefits.map((benefit, index) => (
            ...
            >
              ...
              >
                <div className={cn(
                  "absolute -inset-0.5 rounded-2xl blur-xl opacity-0 group-hover:opacity-30 transition duration-500",
                  benefit.glow
                )} />
                <div className="relative h-full bg-[#0C1322]/90 border border-white/5 rounded-xl p-7 backdrop-blur-sm hover:border-white/10 transition-all duration-300">
                  {/* Enhanced Icon */}
                  <motion.div 
                  ...
                  {/* Enhanced Content */}
                  <h3 className="text-xl font-semibold mb-3 text-white group-hover:text-primary/90 transition-colors">
                    {benefit.title}
                  </h3>
                  <p className="text-slate-400/90 group-hover:text-slate-300/90 transition-colors leading-relaxed">
                    {benefit.description}
                  </p>

                  {/* Enhanced Hover Effect */}
                  <div className="absolute inset-0 rounded-xl transition-all duration-300 group-hover:bg-gradient-to-br from-white/[0.02] to-transparent pointer-events-none" />
                </div>
              </motion.div>
            </motion.div>
          ))}
