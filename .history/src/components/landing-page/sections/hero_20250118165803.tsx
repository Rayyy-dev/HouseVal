    ...
    <section className="container mx-auto px-4 pt-32 pb-24">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
        ...
        <div ref={demoRef} className="relative h-[580px] rounded-3xl overflow-hidden">
          <div className="absolute inset-0 bg-white/80 backdrop-blur-sm border border-border/50">
            <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_right,rgba(var(--primary),0.05),transparent_50%),radial-gradient(circle_at_bottom_left,rgba(var(--primary),0.05),transparent_50%)]" />
                ...
                >
                  <div className="w-full max-w-md px-4">
                    <div className="relative">
                      ...
                      <div className="w-full pl-12 pr-4 py-3 text-base rounded-xl border border-border/50 bg-white shadow-lg">
                        {displayText}
              ...
              {animationStage === 'analyzing' && (
                ...
                >
                  <div className="w-full max-w-md space-y-6">
                    <div className="flex flex-col items-center gap-4 bg-white/90 backdrop-blur-sm rounded-2xl p-8 shadow-lg border border-border/30">
                      <div className="relative">
                    ...
                    <div className="absolute top-1/4 left-1/4 animate-marker-reveal delay-[1000ms]">
                      <div className="relative">
                        ...
                        <div className="relative">
                          ...
                          <div className="h-4 w-4 rounded-full bg-white/90 backdrop-blur-sm border-2 border-primary flex items-center justify-center">
                        ...
                        <div className="absolute left-6 top-1/2 -translate-y-1/2 animate-card-reveal delay-[1100ms]">
                          <div className="bg-white/90 backdrop-blur-sm rounded-xl p-3 shadow-2xl border border-border/50 whitespace-nowrap">
                    ...
                    <div className="absolute top-1/3 right-1/3 animate-marker-reveal delay-[1400ms]">
                      <div className="relative">
                        <div className="relative">
                          ...
                          <div className="h-4 w-4 rounded-full bg-white/90 backdrop-blur-sm border-2 border-emerald-500 flex items-center justify-center">
