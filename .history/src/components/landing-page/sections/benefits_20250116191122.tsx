          ...
          {benefits.map((benefit, index) => (
            ...
            >
              ...
              >
                ...
                <div className="relative h-full bg-background/50 backdrop-blur-sm rounded-xl p-8 border border-border/40 group-hover:border-primary/20 transition-all duration-300">
                  {/* Enhanced Icon */}
