...
export function Hero() {
  ...
  useEffect(() => {
    const sequence = async () => {
      ...
      // Show results with popping elements
                ...
                >
                  <div className="relative w-full h-full">
                    ...
                    <motion.div
                      ...
                      className="absolute left-0 right-0 h-[2px] bg-gradient-to-r from-transparent via-primary to-transparent blur-sm"
                    />
                    
                    {/* Smart AI Analysis Markers */}
                    <div className="absolute inset-0">
                        ...
                        <div className="relative">
                          ...
                          <div className="absolute left-6 top-1/2 -translate-y-1/2">
                            <motion.div
                              ...
                              className="bg-background/80 backdrop-blur-xl rounded-xl p-3 shadow-2xl border border-border/50 whitespace-nowrap"
                            >
                      ...
                      {/* Add more markers with similar animation patterns */}
                      {/* Each marker should have a slightly increased delay */}
                    </div>
                  </div>
                </motion.div>
              )}
              ...
              {animationStage === 'results' && (
                ...
                >
                  <div className="grid grid-cols-2 gap-4 h-full">
                    ...
                    {/* Add more result elements as needed */}
                  </div>
                </motion.div>
              )}
            </AnimatePresence>
